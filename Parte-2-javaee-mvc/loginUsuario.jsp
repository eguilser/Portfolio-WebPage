            ...
            <section class="login-container container">
                <div class="login-form">
                    ...
                    <form id="loginForm" action="./Login" method="post">
                        <input type="hidden" name="returnUrl" value="./LoginUsuario.jsp">
        ...
        <div id="cuerpo">
            ...
            <div class="container-fluid mt-3">
                <form method="post" action="./Logout">
                    ...
                    <input type="button" class="btn-3" value="Formalizar pedido" onclick="EnviarCarrito('RecogerCarrito','cuerpo',carrito); false;">
